...
segmenter:
	wget --quiet http://nlp.stanford.edu/software/stanford-segmenter-2015-12-09.zip
...
postagger:
	wget --quiet http://nlp.stanford.edu/software/stanford-postagger-full-2015-12-09.zip && \
...
parser:
	wget --quiet http://nlp.stanford.edu/software/stanford-parser-full-2015-12-09.zip && \
...
ner:
	wget --quiet http://nlp.stanford.edu/software/stanford-ner-2015-12-09.zip && \
...
WEB-INF/lib/%.jar:
	wget --quiet http://nlp.stanford.edu/software/$*.jar -P WEB-INF/lib
